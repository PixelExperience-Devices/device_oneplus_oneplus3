...
public final class Utils {
    ...
    private static final String TAG = "OnePlusDoze-Utils";
    ...
    protected static void enableGesture(Context context, String gesture, boolean enable) {
        PreferenceManager.getDefaultSharedPreferences(context).edit().putBoolean(gesture, enable).apply();
    }
    ...
    protected static boolean sensorsEnabled(Context context) {
        return isHandwaveGestureEnabled(context) || isPickUpEnabled(context) || isPocketGestureEnabled(context);
    }
