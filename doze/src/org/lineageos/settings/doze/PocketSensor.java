...
public class PocketSensor implements SensorEventListener {
    ...
    private static final String TAG = "OnePlusDoze-PocketSensor";

    // Maximum time for the hand to cover the sensor: 1 second
    private static final int HANDWAVE_MAX_DELTA_NS = 1000 * 1000 * 1000;

    // Minimum time until the device is considered to have been in the pocket: 2 seconds
